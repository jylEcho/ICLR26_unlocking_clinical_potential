...
mask_path = '/path to your mask_path'
output_2d_path = '/path to your output_2d_path'
# output_h5_path = '/path to your test_data_path'

train_patients_path = '/path to your train_patients_path'
liver_boxes_path = '/path to your liver_boxes_path'
window_min = -70
window_max = 180
...
def process_files():
    ...
    for patient in train_patients:
        ...
        case_box = liver_boxes.get(patient, None)
        if case_box is None:
            continue
